  ...
  if (type == "cancel") {
    ...
    displayContent = (
      <Text style={{ marginBottom: 10 }}>
        The recording of this event is processinsg. Click the button to view the
        recording.
      </Text>
    );
    button = (
      <Button
        ...
        onPress={() =>
          Linking.openURL(
            "https://drive.google.com/drive/folders/1TbgpjqdAkBgx5wNNYiNYAoWVqTEc-K-t?usp=sharing"
          )
        }
      />
    );
